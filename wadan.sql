...
--
-- Hôte : localhost
-- Généré le :  Dim 26 jan. 2020 à 16:22
...
CREATE TABLE `bid` (
  ...
  `client_name` varchar(150) COLLATE utf8_bin DEFAULT NULL,
...
(29, 'dgdgdgd', '2020-01-10T23:00:00.000Z', '2019-12-31T23:00:00.000Z', 'In Progress', 0, 'kkk', '454', NULL, NULL, '2020-01-14 21:08:01'),
(30, 'test saud', '2020-01-15T21:00:00.000Z', '2020-01-30T21:00:00.000Z', 'In Progress', 0, 'mmm', '0', NULL, NULL, '2020-01-14 21:08:04'),
(31, 'Ù…Ø´Ø±ÙˆØ¹ ÙˆØ²Ø§Ø±Ø© Ø§Ù„Ø®Ø§Ø±Ø¬ÙŠØ©', '2020-01-14T21:00:00.000Z', '2020-01-24T21:00:00.000Z', 'In Progress', 0, 'pp', '0', '0', NULL, '2020-01-19 17:19:54');
...
CREATE TABLE `purchase_order` (
  ...
  `ship_to` varchar(255) COLLATE utf8_bin NOT NULL,
  ...
  `status` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `prepared_by` varchar(255) COLLATE utf8_bin NOT NULL,
  `date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `purchase_order` (`id`, `num`, `vendor`, `ship_to`, `discount`, `link`, `terms`, `project`, `vat`, `currency`, `created_at`, `deleted_at`, `approved_by`, `status`, `prepared_by`, `date`) VALUES
(1, 1, 1, 'kjkljflka', '50', 'http://www.gp.cpm', 'fjefio joiejioejiog', 26, 1, 'dol', '2020-01-07 00:00:00', '2020-01-26 14:21:01', 6, 'Opened', '4', '2020-01-13'),
(2, NULL, 1, 'chip here ', '55555', 'http://google.com', 'kjhjkhjkhkjhkj', 1, 0, 'dol', NULL, NULL, 6, 'Opened', 'Saud Al Otaibim', '2020-01-13');
...
(1, 'supplier 1', 'lkjklj', '56465456', '2020-01-29 00:00:00', NULL);
...
CREATE TABLE `task` (
  ...
  `priority` varchar(50) COLLATE utf8_bin NOT NULL,
...
(1, 'admin', 'saund@test.om', 'admin', 'SM,AC,SA', 'Saud Al Otaibim', '0000-00-00', NULL),
(2, 'pmanager', 'yehdhihd@test.com', 'pmanager', 'PM,AC', 'Mohamed Yehdhih', '0000-00-00', NULL),
(3, 'pmanager2', 'abdoullah@test.om', 'pmanager2', 'PM', 'Abdoullah Ahmed', '0000-00-00', NULL),
(4, 'sales', 'khalid@test.om', 'sales', 'SM,PM,AC', 'Khaled Abdullah', '0000-00-00', NULL),
(5, 'sidi', 'jjjj', 'oipoipo', 'SM,PM', 'jhajkhjk', '2020-01-07', NULL),
(6, 'adminTesting', 'admin', '123456', 'CEO,PM,AC', 'Saud CEO', NULL, NULL);
...
CREATE TABLE `visit` (
  `id` int(11) NOT NULL,
  `client_name` varchar(150) COLLATE utf8_bin NOT NULL,
...
(3, 'visit numero 1', 'sfsfjks sf', '8500', 4, '2020-01-14', NULL, NULL),
